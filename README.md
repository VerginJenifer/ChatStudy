...
s.listen(5)
c,addr=s.accept()
size=int(input("Enter no. of Frames to send:"))
l=list(range(size))
...
## Output:
![image](https://github.com/VerginJenifer/ChatStudy/assets/136251012/530a2a10-1dc8-45dd-8c1e-349b40b129e9)
![image](https://github.com/VerginJenifer/ChatStudy/assets/136251012/717f578c-254a-419b-b2ba-63095224e85a)
